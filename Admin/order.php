...
$cat=mysqli_query($con,"select * from `order_details` WHERE status!='1'  Order By Sno desc");
if(isset($_GET['id']))
{
	$name = $_GET['id'];
	$sql = "UPDATE `order_details` SET 
    status='0' WHERE sno ='$name'";
											...
											<table id="example" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														...
														<?php } else { ?>
														<td>
														   <a class='edit btn btn-sm btn-primary' href='./order?id=<?php echo $row['sno']; ?>' >Approve</a>
														</td>
														<?php } ?>
														<td>
