...
// 	die();
  ...
  { 
    ...
    $sql = "INSERT INTO product (title,main_image,image,details,oprice,qty,mrp)
    VALUES ('$name','$main_image','$image_upload','$details','$oprice','$qty','$mrp')";
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Add New Product</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							<li><a href="index">Dashboard</a></li>
							<li><a href="productmanage"><span>Manage Product</span></a></li>
										...
										<div class="form-wrap">
											<form action="" method="POST" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<textarea class="form-control" rows="5" id='long_desc' name="details" placeholder="Please Enter Details"></textarea>
												</div>
