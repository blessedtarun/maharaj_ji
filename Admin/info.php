...
include("header.php");
$cat=mysqli_query($con,"select * from `admin` ORDER BY id DESC LIMIT 1");
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">QR Code</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							<li><a href="index.php">Dashboard</a></li>
						    <li class="active"><span>QR Code</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
											...
											<table id="example" class="table table-hover display  pb-30" >
												...
												<tbody>
                                                    ...
                                                    <tr>
														<td><?php echo $i; ?></td>
														<td>
                                                            <img src='<?php echo "../qr/".$row['qr']?>'height="80px" width="80px">
                                                        </td>
														
														<td>
															<a class='edit btn btn-sm btn-primary' href='./info_add.php?id=<?php echo $row['id']; ?>'>Update QR Code</a>
														</td>
													</tr>
