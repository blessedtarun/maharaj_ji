...
include('config.php');
$sno=$_GET['id'];
$sq = "SELECT * FROM `admin` WHERE id = '$sno'";
...
if($imag!='')
{
	move_uploaded_file($_FILES['main_image']['tmp_name'],'../qr/'.$main_image);
    $sql = "UPDATE `admin` Code SET 
    qr='$main_image' WHERE id ='$sno'";
}else
{
    $sql = "UPDATE `admin` Code SET 
    qr='$image1' WHERE id ='$sno'";
}
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Update QR Code</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							<li><a href="index">Dashboard</a></li>
							<li class="active"><span>Update QR Code</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Update QR Code</h6>
									</div>
