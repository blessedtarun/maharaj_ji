...
include("header.php");
$cat=mysqli_query($con,"select * from `product` WHERE pp_id='0' ORDER BY sno DESC");
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Manage Product</h5>
						</div>
						<!-- Breadcrumb -->
						...
						<div class="panel panel-default card-view">
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
										...
										<div class="col-sm-4">
										<a href="product_add"><button class="btn btn-default btn-block" style="margin-bottom:20px;"><i class="fa fa-plus" aria-hidden="true"></i> Create New Record</button></a>
										</div>
										</div>
											...
											<table id="example" class="table table-hover display  pb-30" >
												...
												<tbody>
                                                    ...
                                                    <tr>
														...
														<td>
															<a class='edit btn btn-sm btn-primary' href='./product_u?id=<?php echo $row['sno']; ?>' >Update Quantity</a>
														</td>
														<td>
															<a class='edit btn btn-sm btn-primary' href='./product_edit?id=<?php echo $row['sno']; ?>'>Edit</a>
															<a class='edit btn btn-sm btn-primary' href='./product_delete?id=<?php echo $row['sno']; ?>' onclick='return checkdelete()'>Delete</a>
														</td>
													</tr>
													<?php } else { ?>
